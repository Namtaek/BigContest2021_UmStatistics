...
- 성균관대학교 통계학과 학부 출신 & 통계분석학회 [PSAT](https://www.instagram.com/skku_psat2007/) 출신
- 대회 당시 석사1기/석사2기/학부4학년/석사2기로 팀 구성
- 각자 인과추론/공간통계/시계열/베이지안에 관심 및 일정 수준의 이해에 기반해 분석 진행
- 데이터분석 및 머신러닝 모델링에 대한 다양한 경험 존재
